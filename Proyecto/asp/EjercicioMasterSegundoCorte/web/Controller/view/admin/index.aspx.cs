...
public partial class view_admin_index : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataTable chart=solicitud.cargar_admin_chart();
        if (chart.Rows.Count > 0) {
            AjaxControlToolkit.BarChartSeries data = new AjaxControlToolkit.BarChartSeries();
            data.Name = "Publico";
            decimal[] a = new decimal[3];
            a[0] = decimal.Parse(chart.Rows[0]["publicos"].ToString());
            data.Data = a;
            BarChart1.Series.Add(data);

            AjaxControlToolkit.BarChartSeries data1 = new AjaxControlToolkit.BarChartSeries();
            data1.Name = "Privado";
            decimal[] b = new decimal[3];
           b[0] = decimal.Parse(chart.Rows[0]["privado"].ToString());
            data1.Data = b;
            BarChart1.Series.Add(data1);
        }
