                        ...
                        <div class="x_content">
                            <br />
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    ...
                                    <asp:TextBox ID="Tusername" runat="server" CssClass="form-control has-feedback-left"></asp:TextBox>
                                    <%--<input type="text" class="form-control has-feedback-left" id="inputSuccess2" placeholder="First Name">--%>
                                    <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <asp:TextBox ID="Tmail" runat="server" CssClass="form-control has-feedback-left"></asp:TextBox>
                                    <%--<input type="text" class="form-control has-feedback-left" id="inputSuccess4" placeholder="Email">--%>
                                    <span class="fa fa-envelope form-control-feedback left" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <asp:TextBox ID="Tpass" runat="server" CssClass="form-control has-feedback-left"></asp:TextBox>
                                    <%--<input type="text" class="form-control has-feedback-left" id="inputSuccess4" placeholder="Email">--%>
                                    <span class="fa fa-key form-control-feedback left" aria-hidden="true"></span>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input type="checkbox" class="js-switch"  /> Admin
                                    <div class="ln_solid"></div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                        <span class="right">
                                            <asp:Button ID="BTNactualizarsesion" runat="server" CssClass="btn btn-success" Text="Guardar" />
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left input_mask">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <asp:TextBox ID="Tnombre" runat="server" CssClass="form-control has-feedback-left"></asp:TextBox>
                                    <%--<input type="text" class="form-control has-feedback-left" id="inputSuccess2" placeholder="First Name">--%>
                                    <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <asp:TextBox ID="Tapellido" runat="server" CssClass="form-control has-feedback-left"></asp:TextBox>
                                   <%-- <input type="text" class="form-control" id="inputSuccess3" placeholder="Last Name">--%>
                                    <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <asp:TextBox ID="Tedad" runat="server" CssClass="form-control has-feedback-left" TextMode="Number" type="number"></asp:TextBox>
                                    <%--<input type="text" class="form-control has-feedback-left" id="inputSuccess4" placeholder="Email">--%>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="col-md-1 col-sm-1 col-xs-4">
                                            M:
                                            <asp:RadioButton ID="RM" runat="server" GroupName="sexo" CssClass="flat" required="required" />
                                        </div>
                                        <div class="col-md-1 col-sm-1 col-xs-4">
                                            F:
                                            <asp:RadioButton ID="RF" runat="server" GroupName="sexo" CssClass="flat" />
                                        </div>
                                        <div class="col-md-1 col-sm-1 col-xs-4">
                                            otro:
                                            <asp:RadioButton ID="RO" runat="server" GroupName="sexo" CssClass="flat" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                ...
                                <div class="form-group">
                                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                        <span class="right">
                                            <asp:Button ID="BTNactualizarPerfil" runat="server" CssClass="btn btn-success" Text="Guardar" />
                                        </span>
