...
public partial class view_nueva_contraseña : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if(int.Parse(validez.Rows[0][0].ToString()) != 1) {
            Response.Redirect("http://localhost:52200/home.aspx");
        }
    }
    ...
    protected void BCambiarcontraseña_Click(object sender, EventArgs e)
    {
        ...
        if(int.Parse(validez.Rows[0][0].ToString()) == 1)
        {
            ...
            L_respuesta.Text = "Su contraseña ha sido restablecida, por favor cierre esta página e inicie sesión en la página principal";
