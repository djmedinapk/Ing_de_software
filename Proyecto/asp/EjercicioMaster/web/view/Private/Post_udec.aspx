           ...
           <div class="card ">
                <div class="card-header" style="background-color:#fff;">
                    <div class="d-flex justify-content-between" >
                        <div class="p-8">
                            <h3><asp:Label ID="LpostTitulo" runat="server" Text=""></asp:Label></h3>
                        </div>
                        <div class="p-2">
                            <div class="dropdown">
    ...
    <div class="row cuerpo">
     <div class="col-12">
        ...
        <asp:DataList runat="server" DataSourceID="ODScargarComentarios" style="width:100%;">
            <ItemTemplate>
                <!----------------------------------inicio comentario------------------------>
                <div class="card col-12" style="width:100%; border:0px !important">
                  <div class="d-flex justify-content-between" >
                                <div class="p-2">
                                                  ...
                                                  <asp:Label id="Label8" runat="server" Text='<%# Bind("comentaridpost") %>'></asp:Label>
                                                   <small>responder</small> </a>
                                                        <asp:DataList ID="DLComentarios" runat="server" DataSourceID="ODScargarRespuestas" style="width:100%;" >
                                                            <ItemTemplate>
                                                                <!----------------------------------inicio comentario------------------------>
                                                                <div class="card" style="width: 100%; border-left-width:3px !important;border-left-color:darkgray; border-bottom:0 !important;border-top:0 !important;border-right:0 !important;">
                                                                    <div class="d-flex justify-content-between">
                                                                                <div class="p-2">
