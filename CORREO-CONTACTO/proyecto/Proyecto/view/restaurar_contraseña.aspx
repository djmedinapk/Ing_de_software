<%@ Page Language="C#" MasterPageFile="~/Master1.master" AutoEventWireup="true" CodeFile="~/Controller/view/restaurar_contraseña.aspx.cs" Inherits="view_restaurar_contraseña" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		    ...
		    <div class="row " >		    
		     		<dl >
					  <dt class="col-sm-15">Por favor digite su nombre de usuario</dt>
					  <dd class="col-sm-10">
